...
import { FundamentalScoreDisplay } from './FundamentalScoreDisplay';
...
export const ReportDetails: React.FC<ReportDetailsProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 基本面评分 */}
      {details?.contextSnapshot?.fundamental && (
        <FundamentalScoreDisplay data={details.contextSnapshot.fundamental} />
      )}
    </div>
  );
};
